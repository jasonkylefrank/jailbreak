...
function initFirebaseServices(firebaseApp) {    
    ...
    if (!isRunningOnServer() && useEmulators) {
        ...
        // For HTTPS or Firestore-triggered functions (instead fof "callable functions"), they just worked without “instrumenting”
        //  the app with any code (since I told the firebase CLI that I wanted to emulate functions when I ran firebase init - see firebase.json).
        emulatedFirebaseServices.functions = true;
    }
